...
# One Compartment Kinetics w/ Absorption
  ...
  d1a.p[1, ] <- runif(niter, -1, -0.1)
  d1a.p[2, ] <- runif(niter, d1a.p[1, ]*2, d1a.p[1, ]*1.1)
  d1a.p[3, ] <- runif(niter, 1, 6)
...
# Two Compartment Kinetics w/ Absorption
  ...
  d2a.p[1, ] <- runif(niter, -1, -0.1)
  d2a.p[2, ] <- runif(niter, d2a.p[1, ]*0.8, d2a.p[1, ]*0.05)
  d2a.p[3, ] <- runif(niter, d2a.p[1, ]*2, d2a.p[1, ]*1.1)
  d2a.p[4, ] <- runif(niter, 1, 6)
  d2a.p[5, ] <- runif(niter, d2a.p[4, ] - 1, d2a.p[4, ] - 0.2)
...
# Three Compartment Kinetics w/ Absorption
  ...
  d3a.p[1, ] <- runif(niter, -1, -0.1)
  d3a.p[2, ] <- runif(niter, d3a.p[1, ]*0.8, d3a.p[1, ]*0.05)
  d3a.p[3, ] <- runif(niter, d3a.p[2, ]*0.8, d3a.p[2, ]*0.05)
  d3a.p[4, ] <- runif(niter, d3a.p[1, ]*2, d3a.p[1, ]*1.1)
  d3a.p[5, ] <- runif(niter, 1, 6)
  d3a.p[6, ] <- runif(niter, d3a.p[5, ] - 1, d3a.p[5, ] - 0.2)
  d3a.p[7, ] <- runif(niter, d3a.p[6, ] - 1, d3a.p[6, ] - 0.2)
